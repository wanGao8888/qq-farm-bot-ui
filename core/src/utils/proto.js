...
const typeMappings = [
  ...
  [
    'GetTodayClaimStatusRequest',
    'gamepb.redpacketpb.GetTodayClaimStatusRequest',
  ],
  ...
  [
    ...
    'gamepb.mallpb.GetMallListBySlotTypeRequest',
  ],
  [
    'GetMallListBySlotTypeResponse',
    'gamepb.mallpb.GetMallListBySlotTypeResponse',
  ],
  ...
  // 图鉴
  [
    'GetIllustratedListV2Request',
    'gamepb.illustratedpb.GetIllustratedListV2Request',
  ],
  [
    'GetIllustratedListV2Reply',
  ...
  [
    ...
    'gamepb.friendpb.FriendApplicationReceivedNotify',
  ],
